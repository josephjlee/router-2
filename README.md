...
[![Source Code](http://img.shields.io/badge/source-kadokweb/router-blue.svg?style=flat-square)](https://github.com/kadokweb/router)
[![PHP from Packagist](https://img.shields.io/packagist/php-v/kadokweb/router.svg?style=flat-square)](https://packagist.org/packages/kadokweb/router)
[![Latest Version](https://img.shields.io/github/release/kadokweb/router.svg?style=flat-square)](https://github.com/kadokweb/router/releases)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE)
[![Build](https://img.shields.io/scrutinizer/build/g/kadokweb/router.svg?style=flat-square)](https://scrutinizer-ci.com/g/kadokweb/router)
[![Quality Score](https://img.shields.io/scrutinizer/g/kadokweb/router.svg?style=flat-square)](https://scrutinizer-ci.com/g/kadokweb/router)
[![Total Downloads](https://img.shields.io/packagist/dt/kadokweb/router.svg?style=flat-square)](https://packagist.org/packages/kadokweb/router)
...
<form action="" method="POST">
    ...
    <input type="text" name="first_name" value="Doka"/>
    <input type="text" name="last_name" value="Silva"/>
    <input type="text" name="email" value="doka@kadokweb.com.br"/>

    <button>kadokweb</button>
</form>
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://localhost/kadokweb/router/exemple/spoofing/",
  ...
  CURLOPT_POSTFIELDS => "first_name=Doka&last_name=Silva&email=doka%40kadokweb.com.br",
...
Please see [CONTRIBUTING](https://github.com/kadokweb/router/blob/master/CONTRIBUTING.md) for details.
...
- [Kadokweb](https://github.com/upinside)
- [All Contributors](https://github.com/kadokweb/router/contributors)

## License

The MIT License (MIT). Please see [License File](https://github.com/kadokweb/router/blob/master/LICENSE) for more information.